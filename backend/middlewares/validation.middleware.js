...
const skillIdSchema = z.preprocess(
  toInt,
  z.union([
    z.number().int().positive(),
    z.string().regex(/^[a-f\d]{24}$/i, "Invalid skill id"),
...
const calendarEventSchema = z
  .object({
    ...
    endTime: z
      .preprocess((v) => (v ? toDate(v) : undefined), z.date())
      .optional(),
    reminderMinutes: z
      .preprocess(toInt, z.number().int().min(10).max(60))
      .optional()
      .default(10),
    status: z
    ...
    description: z.string().max(1000).optional().nullable(),
    type: z
      .enum(["teaching", "learning", "swap", "personal"])
      .optional()
      .default("personal"),
    swapClassId: z
...
export const validateCalendarEventUpdateInput = validate(
